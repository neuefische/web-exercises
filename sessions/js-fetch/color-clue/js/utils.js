...
export const restartButton = document.querySelector('[data-js="restartButton"]');
export const restartScreen = document.querySelector('[data-js="restartScreen"]');
export const distanceDisplay = document.querySelector('[data-js="distanceDisplay"]');
