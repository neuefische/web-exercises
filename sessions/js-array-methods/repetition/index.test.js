...
describe('Exercise 1: map', () => {
	test('onlyTitles', () => {
		expect(onlyTitles).toEqual(['Crepes', 'Scrambled Eggs', 'Vegan Salmon', 'Carrot Cake']);
	});
	...
	test('extra: allTitlesInOneString', () => {
		expect(allTitlesInOneString).toBe('Crepes, Scrambled Eggs, Vegan Salmon, Carrot Cake');
	});
});
