...
And now it's your turn: delete the value `null` and write code so that the variables have a value corresponding their name. Use `filter` to achieve this goal.
