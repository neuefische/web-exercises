...
which are set on form submit.
Our goal is to use the states somewhere else in our App.
We want to display them inside our App.js under "Your details." For that we
...
a second time. Outsource the display of the personal details in a new component:
 ...
 2. Move the jsx elements regarding the personal details display into that component.
     Don't forget that jsx always requires a single root-element.
