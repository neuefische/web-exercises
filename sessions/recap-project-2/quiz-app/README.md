...
> **Note:** We recommend to create a new JavaScript file and use this for your form page. Otherwise you might get error messages because some HTML elements do not exist on the form page for which you have added event listeners for your other pages.
